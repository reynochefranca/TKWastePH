...
class RequestHistoriesControllerTest < ActionController::TestCase
  ...
  test "should create request_history" do
    assert_difference('RequestHistory.count') do
      post :create, request_history: { csv_file_path: @request_history.csv_file_path, requested_at: @request_history.requested_at }
    end
  ...
  test "should update request_history" do
    patch :update, id: @request_history, request_history: { csv_file_path: @request_history.csv_file_path, requested_at: @request_history.requested_at }
    assert_redirected_to request_history_path(assigns(:request_history))
  end
